...
public class RobotContainer {
  ...
  // private final Command OneNote  = new Auto();
  ...
  private void configureButtonBindings() {
    ...
    (Constants.swerveController.leftBumper()).whileTrue(new SlowCommand());
    (Constants.swerveController.b()).whileTrue(new FastCommand());
